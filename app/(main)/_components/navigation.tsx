...
export const Navigation = () => {
    ...
    const [isCollapsed, setIsCollapsed] = useState(isMobile) // Mobile will auto collapse
    ...
    const resetWidth = () => {
        if (sidebarRef.current && navbarRef.current) {
            ...
            sidebarRef.current.style.width = isMobile ? "100%" : "240px" // reset according to mobile/web
            ...
            setTimeout(() => setIsResetting(false), 300) // trick for duration animation
        }
    }
    ...
    return (
        <>
            ...
            >
                <div onClick={collapse} role="button" className={cn("h-6 w-6 text-muted-foreground rounded-sm \
